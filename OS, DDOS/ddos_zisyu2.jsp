		...
		<div id="attack_dimention" style="width:100%; height:80%;" class="attack_dimention">
			<form action ="" method="get" class="attack_dimention" id="tamesi">
				...
				<%
						...
						String msfconsole[] = {"msfconsole","show -h","show auxiliary","use auxiliary/dos/tcp/synflood","show options","set RHOST 192.168.20.200","exploit"};
						if(kali_mazi.equals("msfconsole")){
				%>
				<script>
					alert(<%=kali_mazi%>);
				...
				<%
						...
						window.open("","MsgWindow","width=500,height=300").document.write("please input other words");
						<% } 
					}else if(sequ==6){
				kali_mazi = request.getParameter("kali_input");
						String msfconsole[] = {"msfconsole","show -h","show auxiliary","use auxiliary/dos/tcp/synflood","show options","set RHOST 192.168.20.200","exploit"};
						if(kali_mazi.equals("show -h")){
				%>
				<script>
					alert(<%=kali_mazi%>);
				...
				kali_mazi = request.getParameter("kali_input");
						String msfconsole[] = {"msfconsole","show -h","show auxiliary","use auxiliary/dos/tcp/synflood","show options","set RHOST 192.168.20.200","exploit"};
						if(kali_mazi.equals("show auxiliary")){
							%>
				<script>
					alert(<%=kali_mazi%>);
				...
				<%
						...
						<% }
							...
							kali_mazi = request.getParameter("kali_input");
							String msfconsole[] = {"msfconsole","show -h","show auxiliary","use auxiliary/dos/tcp/synflood","show options","set RHOST 192.168.20.200","exploit"};
							if(kali_mazi.equals("use auxiliary/dos/tcp/synflood")){
								%>
							<script>
					alert(<%=kali_mazi%>);
					...
					<%=sequ+=1%>;
						...
						kali_mazi = request.getParameter("kali_input");
						String msfconsole[] = {"msfconsole","show -h","show auxiliary","use auxiliary/dos/tcp/synflood","show options","set RHOST 192.168.20.200","exploit"};
						if(kali_mazi.equals("show options")){
					%>
					<script>
					alert(<%=kali_mazi%>);
				...
				<%
						...
						kali_mazi = request.getParameter("kali_input");
						String msfconsole[] = {"msfconsole","show -h","show auxiliary","use auxiliary/dos/tcp/synflood","show options","set RHOST 192.168.20.200","exploit"};
						if(kali_mazi.equals("set RHOST 192.168.20.200")){
					%>
					<script>
					alert(<%=kali_mazi%>);
