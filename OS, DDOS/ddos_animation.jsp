...
<script>
	...
	function DDOS_Animation(){
		var img_array = ['ddos_anime_01.png','ddos_anime_02.png','ddos_anime_03.png','ddos_anime_04.png','ddos_anime_05.png','ddos_anime_06.png','ddos_anime_07.png','ddos_anime_08.png','ddos_anime_09.png','ddos_anime_10.png','ddos_anime_11.png','ddos_anime_12.png'];
		let si = null;
		clearInterval(si);
		...
		function frame(){
			if(time<=60){
				document.getElementById("presen").innerHTML = "<img style=\"position:absolute; width:80%; height:70%; top:30%; left:10%;\" src=\"img\/"+img_array[iter]+"\" />";
				iter= iter+1;
				time= time+1;
			}
		}
...
<body>
	...
	<button onclick="DDOS_Animation()" style="position:absolute; top:45%; left: 35%; opacity:0; width:30%; height:40%;" class="start_btn"></button>
	<div class="context">
		<div id="presen">
