...
<script>
	...
	function OSCI_Animation(){
		var img_array = ['osci_animation_01 (0).png','osci_animation_01 (1).png','osci_animation_01 (2).png','osci_animation_01 (3).png','osci_animation_01 (4).png','osci_animation_01 (5).png','osci_animation_01 (6).png','osci_animation_01 (7).png','osci_animation_01 (8).png'];
		let si = null;
		clearInterval(si);
		...
		function frame(){
			if(time<=60){
				document.getElementById("presen").innerHTML = "<img style=\"position:absolute; width:80%; height:70%; top:30%; left:10%;\" src=\"osci_img\/"+img_array[iter]+"\" />";
				iter= iter+1;
				time= time+1;
			}
		}
...
<body>
	...
	<button onclick="OSCI_Animation()" style="position:absolute; top:45%; left: 35%; opacity:0; width:30%; height:40%;" class="start_btn"></button>
	<div class="context">
		<div id="presen">
