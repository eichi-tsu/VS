...
<script>
	...
	function Pharming_Animation(){
		var img_array = ['pharming_animation (1).png','pharming_animation (2).png','pharming_animation (3).png','pharming_animation (4).png','pharming_animation (5).png','pharming_animation (6).png','pharming_animation (7).png','pharming_animation (8).png','pharming_animation (9).png','pharming_animation (10).png','pharming_animation (11).png','pharming_animation (12).png','pharming_animation (13).png','pharming_animation (14).png','pharming_animation (15).png'];
		let si = null;
		clearInterval(si);
		...
		function frame(){
			if(time<=60){
				document.getElementById("presen").innerHTML = "<img style=\"position:absolute; width:80%; height:70%; top:30%; left:10%;\" src=\"pharming_img\/"+img_array[iter]+"\" />";
				iter= iter+1;
				time= time+1;
			}
			if(iter==16){
...
<body>
	...
	<button onclick="Pharming_Animation()" style="position:absolute; top:45%; left: 35%; opacity:0; width:30%; height:40%;" class="start_btn"></button>
	<div class="context">
		<div id="presen">
